		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#IndianStatesComboBoxindianstates-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"IndianStatesComboBoxindianstates-display": {
								"semanticObject": "IndianStatesComboBoxindianstates",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=IndianStates.ComboBox.indianstates",
									"url": sap.ui.require.toUrl("IndianStates/ComboBox/indianstates")
								}
							}
						}
					}
